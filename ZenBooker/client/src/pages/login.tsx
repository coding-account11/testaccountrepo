...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: isLogin ? "Welcome back!" : "Account created successfully! Please complete your business profile.",
      });
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            {isLogin 
              ...
              : "Create your account and start sending win-back emails"
            }
          </p>
        </div>
